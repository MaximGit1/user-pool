...
from user_pool.application.common.data.dtos.auth import LoginRequest, AccessToken
...
class LoginHandler:
    ...
    async def handle(self, request: LoginRequest) -> tuple[AccessToken, CookieData]:
